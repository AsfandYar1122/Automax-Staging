...
{
    public class VehicleController : RenderMvcController
    {
        ...
        public ActionResult Index(int id)
        {
            ...
            model.Information = new CarInformation
            {
                ...
                AutoConditionID = Status(veh.AutoUsedStatus),
               ...
               model.Vir = new VirModel
            {
                Exterior = new ExteriorModel
                {
                    ...
                    LeftMirrorId = exteriorData.Data.LeftMirrorId,
                    LeftMirrorData = exteriorData.Data.LeftMirrorData == null ? new PartsDataModel(vehicleWizard.EvaluatorExteriorRatting) : new PartsDataModel(exteriorData.Data.LeftMirrorData),
                    RightMirrorId = exteriorData.Data.RightMirrorId,

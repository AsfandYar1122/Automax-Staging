$(document).ready(function () {
    ...
    $('.carousel-custom-brand').slick({
        ...
        prevArrow: '<button type="button" class="slick-prev-brand"><i class="fa fa-angle-left"></i></button>',
        nextArrow: '<button type="button" class="slick-next-brand"><i class="fa fa-angle-right"></i></button>'
    });

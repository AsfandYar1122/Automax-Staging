...
{
    public class PrintController : RenderMvcController
    {
        private AutoMax.Models.AutoMaxContext db = new AutoMax.Models.AutoMaxContext();
        // GET: Contact
        public ActionResult Index(int id)
        {
            VehicleWizard vehicleWizard = db.VehicleWizards.FirstOrDefault(d => d.VehicleID == id && d.InventoryStatus.InventoryStatusID==1);
            ...
            model.Information = new CarInformation
            {
                ...
                AutoConditionID = veh.AutoCondition,
                Door = veh.AutoDoor,
                ...
                MakerID = veh.Maker,
                YearID = veh.YearName,
                AutoAirBagID = veh.AutoAirBag != null ? (int)veh.AutoAirBag : 0,
                ...
                Has360 = (veh.Has360 == null || veh.Has360 == false) ? false : true,
                Rating= Convert.ToDouble(veh.TotalRatting)
            };
               ...
               model.Vir = new VirModel
            {
                Exterior = new ExteriorModel
                {
                    ...
                    RFDoorId = exteriorData.Data.LFDoorId,
                    ...
                    RoofId = exteriorData.Data.LRockerPanelId,
                    ...
                    RRDoorId = exteriorData.Data.LRockerPanelId,
            ...
            ViewBag.ExteriorImages = new VIRRepository().LoadVIRTabImages(id, VIRPartType.EXTERIOR, url+"/VehicleAttachments/VehicleParts/").Data;
            ViewBag.InterorImages = new VIRRepository().LoadVIRTabImages(id, VIRPartType.INTERIOR, url+"/VehicleAttachments/VehicleParts/").Data;
            ViewBag.FrameImages = new VIRRepository().LoadVIRTabImages(id, VIRPartType.FRAME, url+"/VehicleAttachments/VehicleParts/").Data;
            ViewBag.MechanicsImages = new VIRRepository().LoadVIRTabImages(id, VIRPartType.MECHANICS,url+"/VehicleAttachments/VehicleParts/").Data;
